...
<head>
  ...
  <link rel="stylesheet" href="css\roomadmin.css">
</head>
...
<body>
  ...
  <div class="container-flud distance">
    ...
    <div class="row"  style="margin-top: 0;">
      <div class="col-sm-5 m-auto">
        <h3 class="text-center head-color">Room Admin</h3>
      </div>
    </div>
  ...
  if(isset($_POST['login'])){
    ...
    $sql1 = "SELECT * FROM room_admin WHERE username = '{$username}' AND password = '{$password}'";
