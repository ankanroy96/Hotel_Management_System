...
<body>
    ...
    if(mysqli_num_rows($result) >0) {
     ...
     <div class="row">
       <div class="col-sm-4 m-auto">
         ...
         <label>Current Facebook URL:</label>
         <input type="text" id="username" class="form-control-plaintext" value="<?php echo $row['facebook'];?>" readonly>
       </div>
       </div>
     </div>
    <div class="row">
      <div class="col-sm-4 m-auto">
        ...
        <input type="text" name="newurl" id="newurl" class="form-control" placeholder="Enter New Facebook URL" required>
      </div>
      </div>
    </div>
  ...
  if(isset($_POST['update'])) {
    ...
    $conn1 = mysqli_connect("localhost","root","","hms") or die("Connection failed");
    $sql1 = "update contacts set facebook='{$new_mob}'";
