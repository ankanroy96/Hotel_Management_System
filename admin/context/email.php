...
<body>
    ...
    if(mysqli_num_rows($result) >0) {
     ...
     <div class="row">
       <div class="col-sm-4 m-auto">
         ...
         <input type="text" id="username" class="form-control-plaintext" value="<?php echo $row['email'];?>" readonly>
       </div>
       </div>
     </div>
    <div class="row">
  ...
  if(isset($_POST['update'])) {
    $new_mob=$_POST['newemail'];
    $conn1 = mysqli_connect("localhost","root","","hms") or die("Connection failed");
    $sql1 = "update contacts set email='{$new_mob}'";
