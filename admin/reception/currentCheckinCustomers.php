...
<html>
<head>
  <title>All Check-In Guest</title>
  ...
  function validate()
        ...
        var name = document.getElementById("name");
				...
				if(name.value.trim()=="" && email.value.trim()=="" && code.value.trim()=="")
				{
					alert("Name or Email or Booking Number must be filled.");
					return false;
				}
      }
  </script>
...
<body>
  <?php
    ...
    <div class="container-flud">
      <div class="row">
        <h1>All Check-In Guest</h1>
      </div>
      <form onsubmit="return validate()" action="currentCheckinCustomersSort.php" method="post">
        <div class="row">
          <!----Department----->
    ...
    $sql = "Select * from current_checkin";
