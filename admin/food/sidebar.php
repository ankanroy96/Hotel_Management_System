    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
              ...
              <li>
                  <a href="allFoods.php">All Foods</a>
              </li>
              <li>
                  <a href="allAvailableFoods.php">All Available Foods</a>
              </li>
              <li>
              ...
              <li>
                  <a href="#SizeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Foods</a>
                  <ul class="collapse list-unstyled" id="SizeSubmenu">
                      ...
                      <li>
                          <a href="editFood.php">Edit Food</a>
                      </li>
                      <li>
              ...
              <li>
                  <a href="requestedFoodsList.php">Requested Foods List</a>
              </li>

              <li>
                  <a href="confirmFoodsList.php">Confirm Foods List</a>
              </li>
