...
<body>
  <div class="container-flud">
    ...
    <br>
    <div class="row">
      <h1 style="text-align: center;"><?php echo ucfirst($type);?> Iteams</h1>
    </div>
  ...
  and fc.status=1 and fc.category='$type' order by fc.position";
  ...
  <?php
   ...
   <tr>
     ...
     <td style="text-align: center;"><?php echo $row['quantity']." persons";?></td>
     <?php
     if($fooddiscount==0){
     echo '<td style="text-align: center;">'.$row['price'].' taka</td>';
     }
     else{
     ...
     <td style="text-align: center; width:20%;">
       <form action="foodCartInsert.php?id=2" method="post">
         <div class="row">
           <!----Department----->
           <div class="col-6">
             <div class="form-group">
